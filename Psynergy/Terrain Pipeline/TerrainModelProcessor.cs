...
namespace Psynergy.TerrainPipeline
{
    ...
    public class TerrainModelProcessor : ModelProcessor
    {
        #region Properties
        [Browsable(false)]
        ...
        public override ModelContent Process(NodeContent input, ContentProcessorContext context)
        {
            ...
            context.Logger.LogMessage("[DOM] - TERRAIN MODEL PROCESSOR YER!!!");
        ...
        protected override void ProcessVertexChannel(GeometryContent geometry, int vertexChannelIndex, ContentProcessorContext context)
        {
            ...
            context.Logger.LogMessage("[DOM] - TERRAIN MODEL VERTEX CHANNEL '" + vertexChannelName + "'");
