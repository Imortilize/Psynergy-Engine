...
namespace DPSF.ParticleSystems
{
	...
	[Serializable]
#endif
    class DefaultQuadParticleSystemTemplate : DefaultQuadParticleSystem
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public DefaultQuadParticleSystemTemplate(Game cGame) : base(cGame) { }
        ...
        public override void AutoInitialize(GraphicsDevice cGraphicsDevice, ContentManager cContentManager, SpriteBatch cSpriteBatch)
        {
            ...
            Name = "Default Quad Particle System Template";
