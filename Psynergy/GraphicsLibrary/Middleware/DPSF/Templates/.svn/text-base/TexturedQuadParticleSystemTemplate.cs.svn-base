...
namespace DPSF.ParticleSystems
{
	...
	class TexturedQuadParticleSystemTemplate : DPSF<TexturedQuadParticleSystemTemplateParticle, TexturedQuadParticleSystemTemplateParticleVertex>
	{
		...
		protected virtual void UpdateVertexProperties(ref TexturedQuadParticleSystemTemplateParticleVertex[] sVertexBuffer, int iIndex, DPSFParticle Particle)
		{
		...
		{
			this.RenderProperties.DepthStencilState.DepthBufferEnable = true;
			this.RenderProperties.DepthStencilState.DepthBufferWriteEnable = false;
		}
		...
		protected void UpdateParticlePositionUsingVelocity(TexturedQuadParticleSystemTemplateParticle cParticle, float fElapsedTimeInSeconds)
		{
		...
		/// <param name="cParticle">The Particle to update</param>
		/// <param name="fElapsedTimeInSeconds">How long it has been since the last update</param>
		protected void UpdateParticleToFaceTheCamera(TexturedQuadParticleSystemTemplateParticle cParticle, float fElapsedTimeInSeconds)
		{
