...
namespace DPSF.ParticleSystems
{
    ...
    [Serializable]
#endif
    class DefaultSprite3DBillboardParticleSystemTemplate : DefaultSprite3DBillboardParticleSystem
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public DefaultSprite3DBillboardParticleSystemTemplate(Game cGame) : base(cGame) { }
        ...
        public override void AutoInitialize(GraphicsDevice cGraphicsDevice, ContentManager cContentManager, SpriteBatch cSpriteBatch)
        {
            ...
            Name = "Default Sprite 3D Billboard Particle System Template";
