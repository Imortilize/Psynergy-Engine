//===================================================================
// DPSF Tutorial 5 Source Code - This tutorial shows how to use the Emitter.
//
...
namespace Tutorial
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        string sWindowTitle = "Tutorial 5 - The Emitter";
        ...
        void DrawText()
        {
            ...
            mcSpriteBatch.DrawString(mcFont, "Burst 50 Particles:", new Vector2(5, 300), sPropertyColor);
            mcSpriteBatch.DrawString(mcFont, "X", new Vector2(170, 300), sControlColor);

            mcSpriteBatch.DrawString(mcFont, "Burst Particles for 2 seconds:", new Vector2(5, 325), sPropertyColor);
            mcSpriteBatch.DrawString(mcFont, "C", new Vector2(280, 325), sControlColor);

            mcSpriteBatch.DrawString(mcFont, "Toggle Velocity:", new Vector2(5, 350), sPropertyColor);
            mcSpriteBatch.DrawString(mcFont, "V", new Vector2(155, 350), sControlColor);

            mcSpriteBatch.DrawString(mcFont, "Toggle Rotational Velocity:", new Vector2(5, 375), sPropertyColor);
            mcSpriteBatch.DrawString(mcFont, "B", new Vector2(255, 375), sControlColor);

            mcSpriteBatch.DrawString(mcFont, "Toggle Pivot Point Acceleration:", new Vector2(5, 400), sPropertyColor);
            mcSpriteBatch.DrawString(mcFont, "N", new Vector2(300, 400), sControlColor);
