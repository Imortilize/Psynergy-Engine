//===================================================================
// DPSF Tutorial 2 Source Code - This tutorial shows how to set up
// the Particle Initialization Function to specify a particle's initial
// properties (position, velocity, color, etc.).
//
...
namespace Tutorial
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        string sWindowTitle = "Tutorial 2 - Particle Initialization Function";
        ...
        void DrawText()
        {
            ...
            mcSpriteBatch.DrawString(mcFont, "Use InitialProperties Object:", new Vector2(5, 200), sPropertyColor);
            mcSpriteBatch.DrawString(mcFont, "X", new Vector2(260, 200), sControlColor);

            mcSpriteBatch.DrawString(mcFont, "Use Custom Function:", new Vector2(5, 225), sPropertyColor);
            mcSpriteBatch.DrawString(mcFont, "C", new Vector2(205, 225), sControlColor);

            mcSpriteBatch.DrawString(mcFont, "Use Custom Function 2:", new Vector2(5, 250), sPropertyColor);
            mcSpriteBatch.DrawString(mcFont, "V", new Vector2(225, 250), sControlColor);
        ...
        public void ProcessInputForParticleSystem(float fElapsedTimeInSeconds)
        {
			...
			//=================================================================
			// Tutorial 2 Specific Code
			//=================================================================

            if (KeyWasJustPressed(Keys.X))
            {
                mcMyParticleSystem.UseInitializeParticleUsingInitialPropertiesFunction();
            }

            if (KeyWasJustPressed(Keys.C))
            {
                mcMyParticleSystem.UseInitializeParticlePropertiesFunction();
            }

            if (KeyWasJustPressed(Keys.V))
            {
                mcMyParticleSystem.UseInitializeParticleProperties2Function();
            }
        }
