//===================================================================
// DPSF Tutorial 4 Source Code - This tutorial shows how to use Particle 
// System Events to update the particle system properties.
//
...
namespace Tutorial
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        string sWindowTitle = "Tutorial 4 - Particle System Events";
        ...
        void DrawText()
        {
            ...
            mcSpriteBatch.DrawString(mcFont, "Double Speed:", new Vector2(5, 300), sPropertyColor);
            mcSpriteBatch.DrawString(mcFont, "X", new Vector2(138, 300), sControlColor);

            mcSpriteBatch.DrawString(mcFont, "Normal Speed:", new Vector2(5, 325), sPropertyColor);
            mcSpriteBatch.DrawString(mcFont, "C", new Vector2(140, 325), sControlColor);

            mcSpriteBatch.DrawString(mcFont, "Load Other Events:", new Vector2(5, 350), sPropertyColor);
            mcSpriteBatch.DrawString(mcFont, "V", new Vector2(185, 350), sControlColor);

            mcSpriteBatch.DrawString(mcFont, "Load Original Events:", new Vector2(5, 375), sPropertyColor);
            mcSpriteBatch.DrawString(mcFont, "B", new Vector2(202, 375), sControlColor);
        ...
        public void ProcessInputForParticleSystem(float fElapsedTimeInSeconds)
        {
			...
			//=================================================================
			// Tutorial 4 Specific Code
			//=================================================================

            if (KeyWasJustPressed(Keys.X))
            {
                mcMyParticleSystem.DoubleSimulationSpeed();
            }

            if (KeyWasJustPressed(Keys.C))
            {
                mcMyParticleSystem.NormalSimulationSpeed();
            }

            if (KeyWasJustPressed(Keys.V))
            {
                mcMyParticleSystem.LoadParticleSystem2();
            }

            if (KeyWasJustPressed(Keys.B))
            {
                mcMyParticleSystem.LoadParticleSystem();
            }
        }
