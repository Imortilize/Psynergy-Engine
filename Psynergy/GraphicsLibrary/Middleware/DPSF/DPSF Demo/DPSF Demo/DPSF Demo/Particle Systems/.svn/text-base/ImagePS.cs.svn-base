...
namespace DPSF.ParticleSystems
{
	...
	class ImageParticleSystem : DPSFDefaultAnimatedTexturedQuadParticleSystem<ImageParticle, DefaultTexturedQuadParticleVertex>
	{
		...
		protected override void InitializeRenderProperties()
		{
			...
			RenderProperties.RasterizerState.CullMode = CullMode.None;	// Show the texture on both the front and back of the quad
		...
		public void InitializeParticleImage(ImageParticle cParticle)
		{
			...
			// Specify color White so that we just use the Texture's color, but still allow user to set a tint color if they like.
