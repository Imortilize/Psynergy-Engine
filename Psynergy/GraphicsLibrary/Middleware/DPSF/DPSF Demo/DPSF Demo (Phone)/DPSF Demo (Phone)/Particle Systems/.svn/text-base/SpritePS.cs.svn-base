...
namespace DPSF.ParticleSystems
{
	...
	class SpriteParticleSystem : DPSFDefaultSpriteParticleSystem<SpriteParticle, DefaultSpriteParticleVertex>
	{
		...
		public void LoadCloudEvents()
		{
			...
			InitialProperties.StartWidthMin = 10.0f;
			InitialProperties.StartWidthMax = 30.0f;
			...
			InitialProperties.EndWidthMin = 50.0f;
			InitialProperties.EndWidthMax = 70.0f;
