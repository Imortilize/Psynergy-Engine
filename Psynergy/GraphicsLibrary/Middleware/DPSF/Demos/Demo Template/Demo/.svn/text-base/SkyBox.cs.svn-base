...
namespace Demo
{
    class SkyBox
    {
        ...
        public void Draw(Vector3 sCameraPosition, Matrix sWorld, Matrix sView, Matrix sProjection)
        {
            ...
            // Raise the Sky Box by the specified Height Offset
        ...
        private void SetupVertices()
        {
            ...
            mcVertexBuffer = new VertexBuffer(mcGraphicsDevice, VertexPositionTexture.VertexDeclaration, saVertices.Length, BufferUsage.WriteOnly);
