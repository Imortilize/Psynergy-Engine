...
namespace Psynergy.Graphics
{
    public class Water : ModelNode, IRegister<Water>
    {
        ...
        public override void Initialise()
        {
            ...
            // Set modelName
            ModelName = "Textures/Water/water";
            //Scale *= 0.1f;
        ...
        {
            // Load Offset map
            m_OffsetMap = RenderManager.Instance.LoadTexture2D("Textures/Water/WaterDUDV");
            m_NormalMap = RenderManager.Instance.LoadTexture2D("Textures/Water/WaterNormal");
