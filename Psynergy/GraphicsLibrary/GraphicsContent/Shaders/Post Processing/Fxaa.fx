...
{ 
    position = mul(position, xMatrixTransform); 
} 
...
float4 PixelShaderFunction(float2 TexCoord : TEXCOORD0) : COLOR0
{
    ...
    float2 pixelCenter = float2(TexCoord.x - pixelWidth, TexCoord.y - pixelHeight);
    float4 fxaaConsolePosPos = float4(TexCoord.x, TexCoord.y, TexCoord.x + pixelWidth, TexCoord.y + pixelHeight);
	...
	return FxaaPixelShader(
		...
		float4(8.0 / SCREEN_WIDTH, 8.0 / SCREEN_HEIGHT, -4.0 / SCREEN_WIDTH, -4.0 / SCREEN_HEIGHT),
		0.75f,
		0.166f,
		0.0833f,
        8.0,
	...
	/*return FxaaPixelShader(
        ...
        fxaaConsolePosPos,
        screenSampler,
        float4(-t1 / SCREEN_WIDTH, -t1 / SCREEN_HEIGHT, t1 / SCREEN_WIDTH, t1 / SCREEN_HEIGHT),
        float4(-2.0 / SCREEN_WIDTH, -2.0 / SCREEN_HEIGHT, 2.0 / SCREEN_WIDTH, 2.0 / SCREEN_HEIGHT),
        8.0,
        0.125,
        0.04);*/
